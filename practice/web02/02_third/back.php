...
<body>
    ...
    <div id="all">
        <div id="title">
            Back
            <?php echo date(" m 月 d 日 l")?> |
			今日瀏覽: <?php echo $Visit->find(['date'=>date("Y-m-d")])['visit'];?> |
			累積瀏覽: <?php echo $Visit->sum('visit'); ?> 
			<a href="index.php" style="float: right; font-size:12px" >回首頁</a>
		</div>
        <div id="title2">
			<a href="index.php">
        ...
        <div id="mm">
            ...
            <div class="hal" id="main">
                <div>
                    <marquee behavior="" style="width: 80%;" direction="">請民眾踴躍投稿電子報
						，讓電子報成為大家相互交流、
