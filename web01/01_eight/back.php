    ...
    <div id="main">
      ...
      <div id="ms">
        <div id="lf" style="float: left">
          ...
          <div
            class="dbor"
            style="margin: 3px; width: 95%; height: 20%; line-height: 100px"
          >
          ...
          <table width="100%">
            <tbody>
              <tr>
                ...
                <td>
                  <button
                    onclick="document.cookie='user=';location.replace('?')"
