		...
		<div id="ms">
			...
			<div class="di di ad" style="height:540px; width:23%; padding:0px; margin-left:22px; float:left; ">
				...
				if (isset($_SESSION['login'])): ?>
					<button style="width:100%; margin-left:auto; margin-right:auto; margin-top:2px; height:50px;" onclick="lo('backend.php')">
						返回管理</button>
				<?php else: ?>
